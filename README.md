...
As example, this project has been finished <!--timespan:start(%d)(2021-06-04)-->1723<!--timespan:end--> days ago.

You can add these dynamic timespans with `<!--timespan:start(%d)(2021-06-04)-->1723<!--timespan:end-->`.
...
With that, you will use `<!--timespan:start(%d)(env:1)-->1723<!--timespan:end-->` in the README, and the following action setup
<details>
